...
public final class ShutdownThread extends Thread {
    ...
    static void shutdownInner(final Context context, boolean confirm) {
        ...
        if (confirm) {
            ...
            AlertDialog.Builder confirmDialogBuilder = new AlertDialog.Builder(uiContext, AlertDialog.THEME_MATERIAL)
    ...
    private static void beginShutdownSequence(Context context) {
        ...
        if (!checkAnimationFileExist()) {
            ...
            // shutting down.
            ProgressDialog pd = new ProgressDialog(context, com.android.internal.R.style.Theme_Material_CMRemixDark_Dialog_Alert);
            if (mReboot) {
